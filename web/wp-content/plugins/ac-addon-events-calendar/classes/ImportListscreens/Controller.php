...
class Controller implements AC\Registrable {
	...
	public function __construct( AC\Request $request, AC\ListScreenRepository\Storage $storage, DecoderFactory $decoder_factory ) {
	...
	private function import() {
		...
		$file_content = file_get_contents( ac_addon_events_calendar()->get_dir() . '/export/events.json' );
