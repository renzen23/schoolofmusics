...
* If you can't see the new frame style, you can enable it by logging in to your Duo administrative interface, then enable the updated enrollment on the settings page.
