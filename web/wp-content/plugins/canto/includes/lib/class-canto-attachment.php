...
function canto_be_attachment_field_credit($form_fields, $post)
{
...
add_filter('attachment_fields_to_edit', 'canto_be_attachment_field_credit', 10, 2);
...
function canto_be_attachment_field_credit_save($post, $attachment)
{
...
add_filter('attachment_fields_to_save', 'canto_be_attachment_field_credit_save', 10, 2);
