...
function canto_register_block()
{
    ...
    if (str_contains($subdomain, ".ca.canto.com")){
	    str_replace(".ca.canto.com", "", $subdomain);
    }
...
function canto_enqueue_block_editor_assets()
{
    ...
    wp_enqueue_style('canto-block-editor', CANTO_FBC_URL . 'assets/css/editor.css', array('wp-edit-blocks'));
}

add_action('enqueue_block_editor_assets', 'canto_enqueue_block_editor_assets');
