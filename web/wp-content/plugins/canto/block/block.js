    ...
    if (editor) {
        ...
        blocks.registerBlockType('canto/canto-block', {
            ...
            edit: function (props) {
                ...
                var blockIndex = PostData.getBlockIndex(props.clientId);
                // var PostID = PostData.getCurrentPostId();

                var src = `${args.FBC_URL}block/canto.html`;
                if (args.expire_token < (Date.parse(new Date()) / 1000) || args.subdomain == '' || args.token == '') {
                    src=`${args.FBC_URL}block/error.html`;
                }

                localStorage.setItem("canto_args", JSON.stringify(args));
                localStorage.setItem("canto_wpClientId", props.clientId);
                localStorage.setItem("canto_blockIndex", blockIndex);
                    ...
                    el('div', {className: props.className},
                        el('div', {className: 'canto-image'},
                            ...
                            el(components.Button, {
                                    className: 'button button-large canto-aligncenter',
                                    id: 'canto-button',
                                    onClick: openModal
                                },
                            ...
                            el(components.Modal, {
                                ...
                                el(components.FocusableIframe, {
                                        ...
                                        // src: `${args.FBC_URL}block/canto.html`,
                                        src: src,
