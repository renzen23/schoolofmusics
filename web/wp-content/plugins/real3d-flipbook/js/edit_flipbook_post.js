    ...
    $(document).ready(function() {
        ...
        function selectJpgImages() {
            ...
            var pdf_uploader_1 = wp.media({
                ...
                var arr = pdf_uploader_1.state().get('selection');
                var pages = new Array();
        ...
        function selectPdfFile(onPdfSelected, pdf2jpg) {
            ...
            var pdf_uploader_4 = wp.media({
                ...
                // $('.unsaved').show()
                var arr = pdf_uploader_4.state().get('selection');
