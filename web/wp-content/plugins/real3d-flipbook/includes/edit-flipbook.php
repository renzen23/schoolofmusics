            ...
            <div id="tab-menu"  style="display:none;">
               <div id="poststuff">
                  <div class="meta-box-sortables">
                     ...
                     <div class="postbox closed">
                        <button type="button" class="handlediv" aria-expanded="true"><span class="screen-reader-text">Toggle panel: Close</span><span class="toggle-indicator" aria-hidden="true"></span></button>
                        <h2 class="hndle ui-sortable-handle"><span>Close</span></h2>
                        <div class="inside">
                           <table class="form-table" id="flipbook-btnClose-options">
                              <tbody></tbody>
                           </table>
                           <div class="clear"></div>
                        </div>
...
wp_localize_script( 'real3d-flipbook-admin', 'flipbook', array(json_encode($flipbooks[$current_id]) ));