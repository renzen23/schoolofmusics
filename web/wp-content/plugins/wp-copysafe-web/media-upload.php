      ...
      <?php if ($allow_uploads) { ?>
          <div id="tabs-1"
                              ...
                              <td>
                                  <div class="mfu-wpcsw-plugin-uploader multiple">
                                      ...
                                      <span class="ajaxnonce"
                                            id="<?php echo wp_create_nonce('wpcsw_upload_nonce'); ?>"></span>
                                  </div>
                              </td>
                          <tr>
                              <td>
              ...
              <input type="hidden" value="<?php echo $post_id; ?>" name="postid"
                     id="postid"/>
              <input type="hidden" value="<?php echo WPCSW_PLUGIN_URL; ?>"
                     id="plugin-url"/>
              <input type="hidden" value="<?php echo WPCSW_PLUGIN_PATH; ?>"
                     id="plugin-dir"/>
              <input type="hidden" value="<?php echo WPCSW_UPLOAD_PATH; ?>"
                     id="upload-path"/>
