	...
	public function get_mapping_widgets_order ($import_type) {
		...
		switch ($import_type) {
			...
			case 'ticket':
				...
				break;
			case 'Users':
				$widgets = array('Core Fields','WordPress Custom Fields', 'Custom Fields by WP-Members', 'Custom Fields by Ultimate Member' , 'Billing And Shipping Information',
			...
			case 'Taxonomies':
				...
				break;
			case 'Tags':
				$widgets = array('Core Fields', 'Yoast SEO Fields');
				break;
			case 'Categories':
				$widgets = array('Core Fields','ACF Pro Fields','ACF Fields', 'ACF Repeater Fields', 'Yoast SEO Fields');
				break;
