...
<!--                        <a style="font-size: 17px;" href="--><?php //echo esc_url(add_query_arg(array('page' => 'sm-uci-managers','step' => 'filemanager')));?><!--"><span class="icon-copy-file"></span>--><?php //echo esc_html__('File Manager','wp-ultimate-csv-importer-pro');?><!--</a>-->
...
<!--                        <a style="font-size: 17px;" href="--><?php //echo esc_url(add_query_arg(array('page' => 'sm-uci-managers','step' => 'schedulemanager')));?><!--"><span class="icon-calendar3"></span>--><?php //echo esc_html__('Smart Schedule','wp-ultimate-csv-importer-pro');?><!--</a>-->
...
<!--                        <a style="font-size: 17px;" href="--><?php //echo esc_url(add_query_arg(array('page' => 'sm-uci-managers','step' => 'templatemanager')));?><!--"><span class="icon-insert-template"></span>--><?php //echo esc_html__('Templates','wp-ultimate-csv-importer-pro');?><!--</a>-->
...
<!--                        <a style="font-size: 17px;" href="--><?php //echo esc_url(add_query_arg(array('page' => 'sm-uci-managers','step' => 'logmanager')));?><!--"><span class="icon-document-diagrams"></span>--><?php //echo esc_html__('Log Manager','wp-ultimate-csv-importer-pro');?><!--</a>-->
