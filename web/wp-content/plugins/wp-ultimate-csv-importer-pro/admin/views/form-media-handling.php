...
<label data-tg-off="OFF" data-tg-on="ON" for="gallery-support-btn"  id="download_on" class="tgl-btn" >
	...
	<fieldset class="scheduler-border"> <legend class="scheduler-border" style="margin-top:20px;"><?php echo esc_html__('Image Sizes','wp-ultimate-csv-importer-pro');?></legend>	
				<div class="row">
					<div class="col-xs-6 col-xs-offset-0 col-sm-3 col-sm-offset-1 col-md-2 col-md-offset-1"><label class="wp_img_size"><input type="checkbox" name="media_thumbnail_size" value="thumbnail" checked="checked"><?php echo esc_html__('Thumbnail','wp-ultimate-csv-importer-pro');?></label></div>
					<div class="col-xs-6 col-xs-offset-0 col-sm-3 col-sm-offset-0 col-md-2 col-md-offset-0"><label class="wp_img_size"><input type="checkbox" name="media_medium_size" value="medium"><?php echo esc_html__('Medium','wp-ultimate-csv-importer-pro');?></label></div>
